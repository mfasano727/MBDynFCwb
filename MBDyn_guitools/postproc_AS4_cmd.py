...
#        timestep = 0.01#App.ActiveDocument.initial_values.time_step * 2
        timeout_flag = False
        ...
        for i in range(5):  # read 5 line header of .out file
        ...
        while movline != '':
            ...
            timestep = float(outline_list[3])  # get timestep for each step from .out file
