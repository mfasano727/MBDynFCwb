...
#        if ref_dialog.objectName():
        ref_dialog.setObjectName("ref_dialog")
        ...
        self.parent_ref_box.setGeometry(QRect(20, 30, 141, 61))
        ...
        self.OM_type = QComboBox(ref_dialog)
        ...
        self.OM_type.setGeometry(QRect(220, 30, 121, 61))
        self.OM_type_label = QLabel(ref_dialog)
        self.OM_type_label.setObjectName(u"OM_type_label")
        self.OM_type_label.setGeometry(QRect(220, 0, 121, 31))
        ...
        self.OM_type.connect(self.OM_type, QtCore.SIGNAL("currentIndexChanged(int)"), ref_dialog.set_OM_type)
    ...
    def retranslateUi(self, ref_dialog):
        ...
        self.parent_ref_label.setText(QCoreApplication.translate("ref_dialog", u"choose rference ", None))
        self.vel_x_label.setText(QCoreApplication.translate("ref_dialog", u"x velosity", None))
        self.vel_y_label.setText(QCoreApplication.translate("ref_dialog", u"y velosity", None))
        self.vel_z_label.setText(QCoreApplication.translate("ref_dialog", u"z velosity", None))
        ...
        self.ang_vel_x_label.setText(QCoreApplication.translate("ref_dialog", u"x angular velosity", None))
        self.ang_vel_z_label.setText(QCoreApplication.translate("ref_dialog", u"z  angular velosity", None))
        self.ang_vel_y_label.setText(QCoreApplication.translate("ref_dialog", u"y  angular velosity", None))
