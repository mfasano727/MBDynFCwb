...
# Form implementation generated from reading ui file 'dia_sim_config_tmp.ui',
# licensing of 'dia_sim_config_tmp.ui' applies.
#
# Created: Fri Sep 18 15:43:56 2020
...
class Ui_dia_sim_config(object):
    def setupUi(self, dia_sim_config):
        ...
        self.formLayout_2.setWidget(8, QtWidgets.QFormLayout.SpanningRole, self.cbMethod)
        ...
        self.formLayout_2.setWidget(9, QtWidgets.QFormLayout.SpanningRole, self.cbPbCustomParam)
        ...
        QtCore.QObject.connect(self.cbInitialTime, QtCore.SIGNAL("clicked(bool)"), self.leInitialTime.setEnabled)
        QtCore.QObject.connect(self.cbFinalTime, QtCore.SIGNAL("clicked(bool)"), self.leFinalTime.setEnabled)
        QtCore.QObject.connect(self.cbTimeStep, QtCore.SIGNAL("clicked(bool)"), self.leTimeStep.setEnabled)
